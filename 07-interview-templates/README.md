...
|----------|------|----------|
| **HLD Template** | [hld-template.md](01-frameworks/01-hld-template.md) | Practicing or running a high-level design interview (45–60 min) |
| **LLD Template** | [lld-template.md](01-frameworks/02-lld-template.md) | Practicing or running a low-level design interview |
| **Capacity Estimation** | [capacity-estimation.md](02-cheat-sheets/02-capacity-estimation.md) | Doing back-of-envelope QPS, storage, bandwidth |
| **Trade-offs Cheat Sheet** | [trade-offs-cheat-sheet.md](02-cheat-sheets/01-trade-offs-cheat-sheet.md) | Deciding SQL vs NoSQL, sync vs async, etc. |
| **Interview Question Bank** | [interview-question-bank.md](04-practice-and-prep/02-interview-question-bank.md) | 200+ questions across HLD and LLD topics |
| **Mock Interview Problems** | [mock-interview-problems.md](04-practice-and-prep/03-mock-interview-problems.md) | Timed practice problems |
| **Failure & Recovery Playbook** | [failure-recovery-playbook.md](03-pitfalls-and-recovery/02-failure-recovery-playbook.md) | Failure scenario reference |
| **API Design Template** | [api-design-template.md](01-frameworks/03-api-design-template.md) | API design reference |
| **Database Selection Tree** | [database-selection-tree.md](02-cheat-sheets/03-database-selection-tree.md) | DB decision tree |
| **Architecture by Scale** | [architecture-by-scale.md](02-cheat-sheets/04-architecture-by-scale.md) | Scale-based architectural decisions |
| **Monitoring & SLO Template** | [monitoring-slo-template.md](01-frameworks/04-monitoring-slo-template.md) | Observability reference |
| **Interview Anti-Patterns** | [interview-anti-patterns.md](03-pitfalls-and-recovery/01-interview-anti-patterns.md) | What NOT to do |
