...
- **Core concepts**: [core-concepts/](../core-concepts/) — Databases, caching, networking.
- **Advanced**: [advanced-topics/](../advanced-topics/) — Distributed systems, consistency, transactions.
- **Case studies**: [hld-problems/](../hld-problems/) — URL shortener, cache, messaging, etc.
