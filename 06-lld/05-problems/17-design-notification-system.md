...
class NotificationService:
    def send_order_update(self, user_id: str, message: str) -> None:
...
class RetryDecorator(NotificationChannel):
    def __init__(self, delegate: NotificationChannel, max_attempts: int, backoff_ms: float) -> None:
...
class NotificationRouter:
    ...
    def route(self, notification: Notification) -> list[DeliveryResult]:
...
class InMemoryRateLimiter(RateLimiter):
    ...
    def is_allowed(self, user_id: str, notification_type: NotificationType) -> bool:
...
class NotificationService:
    def __init__(self, router: NotificationRouter, template_engine: NotificationTemplate) -> None:
        self._router = router
        self._template_engine = template_engine

    def send(self, user_id: str, notification_type: NotificationType, data: dict[str, str]) -> None:
