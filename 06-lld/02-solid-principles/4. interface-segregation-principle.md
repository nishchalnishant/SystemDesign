...
class MultiFunctionPrinter(ABC):
    @abstractmethod
    def print(self, d: "Document") -> None: ...
    @abstractmethod
    def scan(self, d: "Document") -> None: ...
    @abstractmethod
    def fax(self, d: "Document") -> None: ...
    @abstractmethod
    def staple(self, d: "Document") -> None: ...

# A basic home printer has to implement fax and staple?
class BasicPrinter(MultiFunctionPrinter):
    def print(self, d: "Document") -> None: ...   # OK
    def scan(self, d: "Document") -> None: ...    # OK
    def fax(self, d: "Document") -> None:
...
class BasicPrinter(Printable, Scannable):
    def print(self, d: "Document") -> None: ...  # Print logic
    def scan(self, d: "Document") -> None: ...   # Scan logic
...
class OrderService(ABC):
    ...
    @abstractmethod
    def apply_discount(self, order_id: str, percent: float) -> None: ...
    @abstractmethod
    def export_to_csv(self, orders: list["Order"]) -> None: ...   # Report concern
    @abstractmethod
    def send_confirmation_email(self, order: "Order") -> None: ...  # Notification concern
...
class ReportService(ABC):
    @abstractmethod
    def export_to_csv(self, orders: list["Order"]) -> None: ...
```
