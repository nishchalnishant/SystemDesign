...
class StripeProcessor(PaymentProcessor):
    def process_payment(self, amount: float) -> bool: return True  # Stripe API
    def refund(self, transaction_id: str) -> bool: return True      # Stripe refund

# LSP VIOLATION: GiftCardProcessor can't refund
class GiftCardProcessor(PaymentProcessor):
    def process_payment(self, amount: float) -> bool: return True   # Deduct from card
    def refund(self, transaction_id: str) -> bool:
