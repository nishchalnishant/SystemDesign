...
```python
class BankAccount:
    # Encapsulation is achieved by naming variables with an underscore prefix.
    # A single underscore _holder is a convention for private fields.
    # A double underscore __balance invokes name mangling for stricter private access.
